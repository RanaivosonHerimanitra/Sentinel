...
#Retrieve ILI
mydata= preprocessing_disease()[["Grippe"]] #ensure this is the same as in #diseases_control.R
...
mydata= preprocessing_disease()[["Grippe"]]
semaine=array()
...
#       missingyear= c(as.numeric(as.Date("2007-01-01"),
#                      as.numeric(as.Date("2013-01-01"))))
#       debut_annee=c(min(debut_annee)-365, missingyear,debut_annee)
