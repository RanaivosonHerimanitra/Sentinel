...
malaria[,malaria_cases:=ifelse(is.na(malaria_cases)==T,"na",malaria_cases)]
...
malaria= merge(unique(malaria[,list(sites,vals)]),lastweek, by.x="sites", by.y="sites")
...
fievre[,SyndF:=ifelse(is.na(SyndF)==T,"na",SyndF)]
...
fievre= merge(unique(fievre[,list(sites,vals)]),lastweek , by.x="sites", by.y="sites")
