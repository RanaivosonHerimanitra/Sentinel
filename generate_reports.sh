...
Rscript "/srv/shiny-server/sentinel_hrmntr/Sentinel/initialize_data.R"
Rscript "/srv/shiny-server/sentinel_hrmntr/Sentinel/execute_report.R"
cd "/srv/shiny-server/sentinel_hrmntr/Sentinel/report"
zip report.zip Diar_sentinelles.pdf ILI_sentinelles.pdf missing_sent.docx palu_autoch_sentinelles.pdf Palu_sentinelles.pdf PFA_sentinelles.pdf report.pdf
Rscript "send_email_report.R"
