...
source("./reporting_plot.R",local = T)
  ...
  #tmp[,deb_sem:=as.numeric(as.Date(deb_sem,origin="1970-01-01"))]
  p =ggplot(data = tmp,aes(x=(as.Date(deb_sem,origin="1970-01-01")),
                           y=cases,fill=Disease))
  #increase space between legend keys:
  p= p + theme(legend.position="bottom", legend.direction="horizontal",  legend.key=element_rect(size=7),
 ...
 # p=p+ scale_fill_discrete("")
  ...
  p=p +geom_text(aes(x=(as.Date("2010-01-01",origin = "1970-01-01")),
                     label="1st", y=700),size=5,angle = 45)
  p=p +geom_text(aes(x=(as.Date("2014-01-01",origin = "1970-01-01")),
                     label="2nd", y=700),size=5,angle = 45)
  p=p +geom_text(aes(x=(as.Date("2015-01-01",origin = "1970-01-01")),
                     label="3rd", y=700),size=5,angle = 45)
