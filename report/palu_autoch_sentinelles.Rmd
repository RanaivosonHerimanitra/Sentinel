...
source("/media/herimanitra/Document/IPM_sentinelle/sentinel_hrmntr 291115/Sentinel/import_data.R");
source("/media/herimanitra/Document/IPM_sentinelle/sentinel_hrmntr 291115/Sentinel/preprocessing.R");require(ggplot2); require(gridExtra)
...
X$deb_sem=as.Date(X$deb_sem,origin="1970-01-01")
 ...
 #adding space between bars:, position = position_dodge(width=0.5)
 d= d + geom_bar(colour="black",stat = "identity" ) 
 # add figure within stacked bar,color text:
 d= d + geom_text(aes(label = vals),color="green",size = 3)
